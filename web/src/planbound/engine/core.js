// GENERATED by tools/port_planbound_engine.py from design/planbound-site.html (script #0).
// The body below is the original running code. Do not hand-edit; re-run the generator.
/* eslint-disable */
export default function installCore(THREE) {
(function(){
'use strict';
...
let last=0,raf=0;PB.wake=function(){if(!raf&&!document.hidden&&!PB.disposed)raf=requestAnimationFrame(tick)} // PORT: stop after dispose;
function tick(now){raf=0;if(PB.disposed||document.hidden)return; // PORT: stop after dispose
const ms=last?now-last:16.67,dt=Math.min(.05,ms/1000);last=now;
